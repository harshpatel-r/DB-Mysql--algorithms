...
Generate the following two result sets:
    ...
    Query the number of ocurrences of each occupation in OCCUPATIONS. Sort the occurrences in ascending 
    order, and output them in the following format:

    There are a total of [occupation_count] [occupation]s.

    where [occupation_count] is the number of occurrences of an occupation in OCCUPATIONS & [occupation] 
...
SELECT CONCAT(NAME,"(" , SUBSTR(OCCUPATION,1,1),")") as combined FROM  OCCUPATIONS order by combined;
